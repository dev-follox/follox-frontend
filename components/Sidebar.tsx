        ...
        <div className="px-4 mb-4">
          ...
          <div className="space-y-0.5 ml-2 border-l-2 border-gray-200 pl-2">
            ...
            {isCompany && (
              ...
              >
                <span className={`mr-2 ${isActive('/company/bloggers') ? 'text-white' : 'text-gray-400'}`}>└</span>
        ...
        {isCompany && (
          <div className="px-4 mb-4">
            ...
            <div className="space-y-0.5 ml-2 border-l-2 border-gray-200 pl-2">
              ...
              >
                <span className={`mr-2 ${isActive('/gtm/qa') ? 'text-white' : 'text-gray-400'}`}>└</span>
              ...
              >
                <span className={`mr-2 ${isActive('/gtm/strategy') ? 'text-white' : 'text-gray-400'}`}>└</span>
